...
import be.kwakeroni.ghast.convert.image.PDF;
...
public final class PUML implements TextualType {
    ...
    public static Function<Content<PUML, byte[]>, Generator<PDF>> pdf() {
        return Generator.transformer(PDF.type, PUMLImpl.imageWriter(FileFormat.PDF));
    }
